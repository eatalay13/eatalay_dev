...
function ContactCTA() {
  ...
  return (
    <motion.section
      className="relative rounded-xl overflow-hidden mx-auto dark:shadow-lg dark:shadow-indigo-900/20"
        ...
        <div className="md:col-span-3 text-white">
          ...
          >
            ...
            >
              ...
              {t("getInTouch")}
              <FiArrowRight className="ml-2 transition-transform duration-300 hover:translate-x-1" />
            </Link>
          </motion.div>
        </div>
        ...
        <div className="md:col-span-2 flex items-center justify-center md:justify-end">
          ...
          >
            ...
            <div className="mt-6 pt-4 border-t border-white/10 dark:border-white/5">
              <Link
                href="/contact"
                className="text-sm font-medium text-white flex items-center hover:text-blue-200 dark:hover:text-blue-300 transition-colors"
              >
                {t("contactInfo")}
