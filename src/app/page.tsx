...
export default function Home() {
  return (
    <div className="w-[35rem] sm:w-[116rem] h-[56.6rem] mx-auto">
      ...
      >
        <div
          className="sm:w-[5.6rem] sm:h-[5.6rem] mb-[2.4rem] w-[10.4rem] h-[10.4rem]"
        >
          <Image
        ...
        <a
          ...
          className="bg-white text-black w-[35rem] sm:w-[15.3rem] h-[6.5rem] sm:h-[4rem] sm:py-[1.1rem] sm:px-[4.5rem] rounded-full
